...
bucket_name = "matolala.sports-analytics-data-lake"  # Change to a unique S3 bucket name
glue_database_name = "glue_nba_data_lake"
athena_output_location = f"s3://{bucket_name}/athena-results/"

# Sportsdata.io configurations (loaded from .env)
api_key = os.getenv("bc319e15883b4831ae4e0800af49afdf")  # Get API key from .env
nba_endpoint = os.getenv("https://api.sportsdata.io/v3/nba/scores/json/")  # Get NBA endpoint from .env
